  ...
  return (
    <Router useAuth={useAuth}>
      <PrivateSet wrap={WrapperLayout as any} unauthenticated="login" roles={['guest', 'admin']}>
        ...
        <Set wrap={AdminScaffoldLayout} title="Entities" titleTo="entities" buttonLabel="New Entity" buttonTo="newEntity" showSearch={true}>
      ...
      <PrivateSet wrap={WrapperLayout as any} unauthenticated="login" roles={['admin']}>
        ...
        <Set wrap={AdminScaffoldLayout as any} title="Users" titleTo="users" buttonLabel="New User" buttonTo="newUser" showSearch={true}>
